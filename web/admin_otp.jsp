...
@media (max-width: 500px) {
 ...
 .navbar-nav .dropdown:hover .dropdown-menu {
  ...
  <div class="feedback-section">
    ...
    <p id="timer" style="color:green">OTP Sent Successfully! Resend available in <span id="countdown">180</span> seconds</p>
  </div>
</div>
...
var otp = document.getElementById("exampleInput").value;
    ...
    xhr.open('POST','adminOTP_Code',true);
  ...
  function resendOTP() {
    if (resendAvailable) {
      const xhr = new XMLHttpRequest();
      xhr.open('POST', 'AdminResend', true);
      xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
