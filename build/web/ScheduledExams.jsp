    ...
    if (cookies != null) {
        for (Cookie cookie : cookies) {
            ...
            try {
                ...
                // Retrieve quizzes with status = 1 for the logged-in user
                String query = "SELECT quiz_name, quiz_code, date FROM user_quizzes WHERE status = 0 AND email = ? ORDER BY date DESC";
            ...
            <div class="col-md-4 mt-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" id="btnstart" onclick="enterQuizcode()">Start Exam</button>
                    </div>
                </div>
            </div>
            ...
            <%
             ...
             if(count==0)
{
            %><div class="notfound"><h5 class="notxt">No Exams founnd</h5></div>
            <%
}
            %>
        </div>
